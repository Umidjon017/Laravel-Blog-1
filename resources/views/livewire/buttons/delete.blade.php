<div class="p-2 bg-red-300 rounded">
    <a wire:click="confirmPostDelation" wire:loading.attr="disabled" class="cursor-pointer">
    ...
    <x-jet-dialog-modal wire:model="confirmPostDelation">
        <x-slot name="title">
            {{ __('Delete Post') }}
        </x-slot>
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="$toggle('confirmPostDelation')" wire:loading.attr="disabled">
                {{ __('Nevermind') }}
